...
std::unordered_map<string, string> MessageManager::_enResources = {
	...
	{ "RetroAchievements", u8"RetroAchievements" },
	{ "RaGameCompleted", u8"Game completed - all achievements earned!" },
	{ "RaCheatsDisabled", u8"Cheats are disabled in RetroAchievements hardcore mode" },
	{ "RaMovieDisabled", u8"Movie playback is disabled in RetroAchievements hardcore mode" },
	{ "RaLoadStateDisabled", u8"Loading save states is disabled in RetroAchievements hardcore mode" },
	{ "RaResumeSoftcore", u8"Resumed from a save state - switched to softcore mode" },
