...
// OpenGL-based renderer for Windows using WGL that supports libretro GLSL shader presets.
// Used in place of the DirectX Renderer when a GLSL shader is selected.
class WglRenderer : public IRenderingDevice
{
private:
	struct GlHud
	{
...
public:
	WglRenderer(Emulator* emu, HWND hwnd);
	virtual ~WglRenderer();
